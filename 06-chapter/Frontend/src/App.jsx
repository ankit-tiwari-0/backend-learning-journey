...
const App = () => {
  return (
    <div className='m-0 p-0 box-border h-screen w-full'>
      <Nav />
      <div className=' bg-gradient-to-br from-blue-700 via-purple-600 to-indigo-700 rounded-[32px] px-10 ml-7 mr-7 py-20 text-white shadow-[0_10px_40px_rgba(0,0,0,0.15)] overflow-hidden relative my-10'>
